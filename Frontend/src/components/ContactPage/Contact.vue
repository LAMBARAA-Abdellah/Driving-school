<template>
        ...
        <div class="content">
            ...
            <div class="form">
                <h1>Get in Touch</h1>
                <p>If you want to ask a question send a message or submit a testimonial, please use the online form below.</p>
                <form >
                    ...
                    <div class="form-group">
                        <input name="tel" id="" cols="30" rows="10" placeholder="Phone">
                    </div>
                    <div class="form-group">
